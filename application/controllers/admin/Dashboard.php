...
class Dashboard extends CI_Controller {
    ...
    public function index(){
        ...
        $admin = $this->db->get_where('user',array("role" => "admin"))->result_array();
        $data['admin'] = count($admin);
        $farmer = $this->db->get_where('user',array("role" => "farmer"))->result_array();
        $data['farmer'] = count($farmer);
        $delivery = $this->db->get_where('user',array("role" => "delivery"))->result_array();
        $data['delivery'] = count($delivery);
