...
<i class="fa fa-pencil"></i> &nbsp;
        ...
        <?php } else { ?>
            ...
            <?php } else { ?> 
                    Farmer Edit 
            <?php } ?>
        <?php } ?><a href="<?php echo base_url('admin/user/all_user_list') ?>" class="btn btn-info btn-sm pull-right"><i class="fa fa-list"></i> All Users </a>
                   ...
                   <input type="text" name="mobile" class="form-control" value="<?php echo $user->mobile; ?>">
                    ...
                    <div class="col-sm-12">
                      <select class="form-control form-control-line" name="country">
                        ...
                        <?php if($user->role != "admin") {  ?>         
                          Delivery Boy <input <?php if($user->role == "delivery"){echo "checked";}; ?> type="radio" onclick="javascript:yesnoCheck();" name="role" id="yesCheck" value="delivery"> 
						  Farmer <input <?php if($user->role == "farmer"){echo "checked";}; ?> type="radio" onclick="javascript:yesnoCheck();" name="role" id="noCheck" value="farmer"><br>
    					<?php } ?>
